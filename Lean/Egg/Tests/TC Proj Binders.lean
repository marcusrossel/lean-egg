...
/--
trace: [egg.rewrites.derived] Derived (4)
  [egg.rewrites.derived] #0[0?69632,0](⇒)
    [egg.rewrites.derived] HMul.hMul = Mul.mul
    [egg.rewrites.derived] LHS MVars
        []
    [egg.rewrites.derived] RHS MVars
        []
  [egg.rewrites.derived] #0[0?69632,0](⇐)
    [egg.rewrites.derived] Mul.mul = HMul.hMul
    [egg.rewrites.derived] LHS MVars
        []
    [egg.rewrites.derived] RHS MVars
        []
  [egg.rewrites.derived] #0[0?69632,2](⇒)
    [egg.rewrites.derived] Mul.mul = Nat.mul
    [egg.rewrites.derived] LHS MVars
        []
    [egg.rewrites.derived] RHS MVars
        []
  [egg.rewrites.derived] #0[0?69632,2](⇐)
    [egg.rewrites.derived] Nat.mul = Mul.mul
    [egg.rewrites.derived] LHS MVars
        []
    [egg.rewrites.derived] RHS MVars
        []
