    ...
    case neg =>
      ...
      case neg =>
        ...
        calc (n + 1).choose r
          ...
          _ = (n + 1)! / (r ! * (n + 1 - r)!)                                        := by sorry -- egg [Nat.add_comm, Nat.add_sub_cancel, Nat.mul_comm, Nat.mul_assoc, Nat.div_mul_div_comm, Nat.factorial, Nat.mul_factorial_pred, todo; h₂, h₄, h₅, h₆]
