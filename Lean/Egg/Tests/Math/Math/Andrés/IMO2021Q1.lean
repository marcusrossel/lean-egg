...
theorem exists_finset_3_le_card_with_pairs_summing_to_squares {n : ℕ} (hn : 100 ≤ n) :
  ...
  · suffices a ∉ {b, c} ∧ b ∉ {c} by
    -- egg! [Finset.card_insert_of_not_mem this.1, Finset.card_insert_of_not_mem this.2,
    ...
    apply of_eq_true
    egg! [Finset.mem_insert, Finset.mem_singleton, Finset.mem_singleton, hab, hbc, hbc]
