...
info: [egg.encoded] Encoded
  ...
  [egg.encoded] #0(⇔)
    [egg.encoded] LHS: (◇ * (app (◇ (→ * *) (app (◇ (→ * (→ * *)) (app (◇ (→ * (→ * (→ * *))) (app (◇ (→ * (→ * (→ * (→ * *)))) (app (◇ (→ * (→ * (→ * (→ * (→ * *))))) (app (◇ (→ * (→ * (→ * (→ * (→ * (→ * *)))))) (const HAdd.hAdd 0 0 0)) (◇ * (const Nat)))) (◇ * (const Nat)))) (◇ * (const Nat)))) (◇ * (app (◇ (→ * *) (app (◇ (→ * (→ * *)) (const instHAdd 0)) (◇ * (const Nat)))) (◇ * (const instAddNat)))))) (◇ * ?333))) (◇ * ?334)))
    [egg.encoded] RHS: (◇ * (app (◇ (→ * *) (app (◇ (→ * (→ * *)) (app (◇ (→ * (→ * (→ * *))) (app (◇ (→ * (→ * (→ * (→ * *)))) (app (◇ (→ * (→ * (→ * (→ * (→ * *))))) (app (◇ (→ * (→ * (→ * (→ * (→ * (→ * *)))))) (const HAdd.hAdd 0 0 0)) (◇ * (const Nat)))) (◇ * (const Nat)))) (◇ * (const Nat)))) (◇ * (app (◇ (→ * *) (app (◇ (→ * (→ * *)) (const instHAdd 0)) (◇ * (const Nat)))) (◇ * (const instAddNat)))))) (◇ * ?334))) (◇ * ?333)))
